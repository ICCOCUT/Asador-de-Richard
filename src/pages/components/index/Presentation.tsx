...
export default function Presentation() {
	return (
		<section
			className='text-gray-400 body-font bg-slate-600  bg-no-repeat bg-cover bg-[url(https://raw.githubusercontent.com/ICCOCUT/Asador-de-Richard/main/public/img/heroImage.png)]
		'>
			<div className='container px-5 pt-52 pb-24 mx-auto'>
