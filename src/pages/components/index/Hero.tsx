...
export default function Hero() {
	return (
		<div>
			<section className='text-gray-400 bg-gray-600  body-font bg-no-repeat bg-cover bg-[url(https://raw.githubusercontent.com/ICCOCUT/Asador-de-Richard/main/public/img/delicious.png)]'>
